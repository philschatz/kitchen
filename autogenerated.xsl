...
<xsl:transform xmlns="http://www.w3.org/1999/xhtml"
   ...
   <xsl:template mode="ANNOTATE_MODE" match="/h:html/h:body">
      <xsl:copy inherit-namespaces="no">
         <xsl:if test="@temp:replace-id">
            <xsl:message>This element was already matched by a different selector @temp:replace-id={@temp:replace-id}</xsl:message>
         </xsl:if>
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e4']">
      ...
      <xsl:copy>
         ...
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
               <xsl:apply-templates mode="NUMBER_MODE" select="r:link-text/node()">
                  <xsl:with-param tunnel="yes" name="nearestReplacerContext" select="."/>
               </xsl:apply-templates>
            </xsl:variable>
            <xsl:if test="not(string-length($linktextValue) &gt; 0)">
               <xsl:message terminate="yes">Computed link text for element is empty. The nodes were: [<xsl:copy-of select="r:link-text"/>]</xsl:message>
            </xsl:if>
            <xsl:attribute name="temp:linktext">{$linktextValue}</xsl:attribute>
         </xsl:if>
   ...
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e29']">
      ...
      <xsl:copy>
         ...
         <inject-element inject-name="div"
            ...
            <r:dump-bucket temp:id="DUMP_BUCKET_iamaglossarypagebucket_d1e64"
         ...
         <inject-element inject-name="div"
            ...
            <r:dump-bucket temp:id="DUMP_BUCKET_iamapagebucket-key-equations_d1e71"
         ...
         <inject-element inject-name="div"
            ...
            <r:dump-bucket temp:id="DUMP_BUCKET_iamapagebucket-summary_d1e78"
         ...
         <inject-element inject-name="div"
            ...
            <r:dump-bucket temp:id="DUMP_BUCKET_iamapagebucket-exercises_d1e85"
   ...
   <xsl:template mode="ANNOTATE_MODE"
                 match="/h:html/h:body/*[@data-type='chapter']/*[@data-type='document-title']">
      <xsl:copy inherit-namespaces="no">
         <xsl:if test="@temp:replace-id">
            <xsl:message>This element was already matched by a different selector @temp:replace-id={@temp:replace-id}</xsl:message>
         </xsl:if>
         <xsl:attribute name="temp:replace-id">d1e89</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e89' is actually: /h:html/h:body/*[@data-type='chapter']/*[@data-type='document-title']-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e89']">
            <!--r:this-->
      <xsl:copy>
         <xsl:apply-templates select="@*"/>
         <inject-element inject-name="span" inject-class="os-number">Chapter <r:dump-counter name="chapterCounter"/>
         </inject-element>
         <inject-element inject-name="span" inject-class="os-divider"/>
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e89']">
      <xsl:param tunnel="yes" name="chapterCounter"/>
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e107</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e107' is actually: /h:html/h:body/*[@data-type='chapter']//*[@class='key-equations']-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e107']"><!--TODO: BUG: Unwrap the section and remove the title-->
            <!--r:this-->
      <xsl:copy>
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e107']">
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e116</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e116' is actually: /h:html/h:body/*[@data-type='chapter']//*[@class='summary']-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e116']"><!--TODO: BUG: Unwrap the section and remove the title-->
            <!--r:this-->
      <xsl:copy>
         <xsl:attribute name="data-todo">UNWRAPME</xsl:attribute>
         <xsl:apply-templates select="@*"/>
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e116']">
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e126</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e126' is actually: /h:html/h:body/*[@data-type='chapter']//*[@class='exercises']-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e126']"><!--TODO: BUG: Unwrap the section and remove the title-->
            <!--r:this-->
      <xsl:copy>
         <xsl:attribute name="data-todo">UNWRAPME</xsl:attribute>
         <xsl:apply-templates select="@*"/>
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e126']">
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
   ...
   <!--@temp:replace-id='d1e135' is actually: /h:html/h:body/*[@data-type='chapter']//*[@data-type='glossary']-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e135']"><!--TODO: BUG: Unwrap the section and remove the title-->
            <!--r:this-->
      <xsl:copy>
         <xsl:attribute name="data-todo">UNWRAPME</xsl:attribute>
         <xsl:apply-templates select="@*"/>
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e135']">
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e144</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e144' is actually: /h:html/h:body/*[@data-type='chapter']//*[@data-type='exercise'][*[@data-type='solution']]-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e144']">
            <!--r:this-->
      <xsl:copy>
         <xsl:apply-templates select="@*"/>
         <r:link-text>
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e144']">
      <xsl:param tunnel="yes" name="chapterCounter"/>
      <xsl:param tunnel="yes" name="exerciseCounter"/>
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e166</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e166' is actually: /h:html/h:body/*[@data-type='chapter']//*[@data-type='exercise'][*[@data-type='solution']]/*[@data-type='solution']-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e166']">
               <!--r:this-->
      <xsl:copy>
         <xsl:apply-templates select="@*"/>
         <r:link to="parent"/>
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e166']">
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e177</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e177' is actually: /h:html/h:body/*[@data-type='chapter']//*[@data-type='exercise'][not(*[@data-type='solution'])]-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e177']">
            <!--r:this-->
      <xsl:copy>
         <xsl:apply-templates select="@*"/>
         <r:link-text>
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e177']">
      <xsl:param tunnel="yes" name="chapterCounter"/>
      <xsl:param tunnel="yes" name="exerciseCounter"/>
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e200</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e200' is actually: /h:html/h:body/*[@data-type='chapter']//h:table-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e200']">
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e200']">
      <xsl:param tunnel="yes" name="chapterCounter"/>
      <xsl:param tunnel="yes" name="tableCounter"/>
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e248</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e248' is actually: /h:html/h:body/*[@data-type='chapter']//h:figure-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e248']">
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e248']">
      <xsl:param tunnel="yes" name="chapterCounter"/>
      <xsl:param tunnel="yes" name="figureCounter"/>
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e282</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e282' is actually: /h:html/h:body/*[@data-type='chapter']//h:figure/h:figcaption-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e282']">
               <!--r:this-->
      <xsl:copy>
         <xsl:apply-templates select="@*"/>
         <inject-element inject-name="strong">
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e282']">
      <xsl:param tunnel="yes" name="chapterCounter"/>
      <xsl:param tunnel="yes" name="figureCounter"/>
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e308</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e308' is actually: /h:html/h:body/*[@data-type='chapter']//*[@data-type='note'][@class][func:hasClass(@class, 'link-to-learning')]-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e308']">
            <!--r:this-->
      <xsl:copy>
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e308']">
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e322</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e322' is actually: /h:html/h:body/*[@data-type='chapter']//*[@data-type='note'][@class][func:hasClass(@class, 'sciences-interconnect')]-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e322']">
            <!--r:this-->
      <xsl:copy>
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e322']">
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e336</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e336' is actually: /h:html/h:body/*[@data-type='chapter']//*[@data-type='note'][@class][func:hasClass(@class, 'chemist-portrait')]-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e336']">
            <!--r:this-->
      <xsl:copy>
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e336']">
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e350</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e350' is actually: /h:html/h:body/*[@data-type='chapter']//*[@data-type='note'][@class][func:hasClass(@class, 'everyday-life')]-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e350']">
            <!--r:this-->
      <xsl:copy>
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e350']">
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
   ...
   <xsl:template mode="ANNOTATE_MODE"
                 match="/h:html/h:body/*[@data-type='chapter']/*[@data-type='page'][not(@class)]">
      <xsl:copy inherit-namespaces="no">
         <xsl:if test="@temp:replace-id">
            <xsl:message>This element was already matched by a different selector @temp:replace-id={@temp:replace-id}</xsl:message>
         </xsl:if>
         <xsl:attribute name="temp:replace-id">d1e364</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e364' is actually: /h:html/h:body/*[@data-type='chapter']/*[@data-type='page'][not(@class)]-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e364']">
            <!--r:this-->
      <xsl:copy>
         <xsl:apply-templates select="@*"/>
         <r:link-text>
            <r:copy-content temp:id="COPY_CONTENT__d1e370"
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e364']">
      <xsl:param tunnel="yes" name="chapterCounter"/>
      <xsl:param tunnel="yes" name="sectionCounter"/>
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         ...
         <!--r:children selector="*[@data-type='page'][not(@class)]"-->
         <xsl:apply-templates mode="NUMBER_MODE" select="node()"/>
      </xsl:copy>
   </xsl:template>
   <xsl:template mode="ANNOTATE_MODE"
                 match="/h:html/h:body/*[@data-type='chapter']/*[@data-type='page'][not(@class)]/*[@data-type='document-title']">
      <xsl:copy inherit-namespaces="no">
         <xsl:if test="@temp:replace-id">
            <xsl:message>This element was already matched by a different selector @temp:replace-id={@temp:replace-id}</xsl:message>
         </xsl:if>
         <xsl:attribute name="temp:replace-id">d1e379</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e379' is actually: /h:html/h:body/*[@data-type='chapter']/*[@data-type='page'][not(@class)]/*[@data-type='document-title']-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e379']">
               <!--r:this-->
      <xsl:copy>
         <xsl:apply-templates select="@*"/>
         <inject-element inject-name="span" inject-class="os-text">
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e379']">
      <xsl:param tunnel="yes" name="chapterCounter"/>
      <xsl:param tunnel="yes" name="sectionCounter"/>
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
   ...
   <xsl:template mode="ANNOTATE_MODE"
                 match="/h:html/h:body/*[@data-type='chapter']/*[@data-type='page'][@class][func:hasClass(@class, 'introduction')]">
      <xsl:copy inherit-namespaces="no">
         <xsl:if test="@temp:replace-id">
            <xsl:message>This element was already matched by a different selector @temp:replace-id={@temp:replace-id}</xsl:message>
         </xsl:if>
         <xsl:attribute name="temp:replace-id">d1e395</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e395' is actually: /h:html/h:body/*[@data-type='chapter']/*[@data-type='page'][@class][func:hasClass(@class, 'introduction')]-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e395']">
            <!--r:this-->
      <xsl:copy>
         <xsl:apply-templates select="@*"/>
         <r:link-text>
            <r:copy-content temp:id="COPY_CONTENT__d1e401"
                            selector="*[@data-type='document-title']/node()"/>
         </r:link-text>
         <h:div class="os-chapter-outline">
            <h:div class="os-title">Chapter Outline</h:div>
            <xsl:for-each select="../*[@data-type='page']">
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e395']">
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
   ...
   <xsl:template mode="ANNOTATE_MODE"
                 match="/h:html/h:body/*[@data-type='chapter']/*[@data-type='page'][@class][func:hasClass(@class, 'introduction')]/*[@data-type='document-title']">
      <xsl:copy inherit-namespaces="no">
         <xsl:if test="@temp:replace-id">
            <xsl:message>This element was already matched by a different selector @temp:replace-id={@temp:replace-id}</xsl:message>
         </xsl:if>
         <xsl:attribute name="temp:replace-id">d1e412</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e412' is actually: /h:html/h:body/*[@data-type='chapter']/*[@data-type='page'][@class][func:hasClass(@class, 'introduction')]/*[@data-type='document-title']-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e412']">
               <!--r:this-->
      <xsl:copy>
         <xsl:apply-templates select="@*"/>
         <inject-element inject-name="span" inject-class="os-text">
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e412']">
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e425</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e425' is actually: /h:html/h:body/*[@data-type='page'][@class][func:hasClass(@class, 'preface')]-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e425']">
         <!--r:this-->
      <xsl:copy>
         <xsl:apply-templates select="@*"/>
         <!--r:children selector=""-->
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e425']">
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
   ...
   <xsl:template mode="ANNOTATE_MODE"
      ...
      <xsl:copy inherit-namespaces="no">
         ...
         <xsl:attribute name="temp:replace-id">d1e432</xsl:attribute>
         <xsl:apply-templates mode="ANNOTATE_MODE" select="@*|node()"/>
      </xsl:copy>
   </xsl:template>
   <!--@temp:replace-id='d1e432' is actually: /h:html/h:body/*[@data-type='page'][@class][func:hasClass(@class, 'preface')]/*[@data-type='document-title']-->
   <xsl:template mode="EXPAND_MODE" match="*[@temp:replace-id = 'd1e432']">
            <!--r:this-->
      <xsl:copy>
         <xsl:apply-templates select="@*"/>
         <inject-element inject-name="span" inject-class="os-text">
   ...
   <xsl:template mode="NUMBER_MODE" match="*[@temp:replace-id = 'd1e432']">
      <xsl:copy>
         <xsl:apply-templates mode="NUMBER_MODE" select="@*"/>
         <xsl:if test="r:link-text/node()">
            <xsl:variable name="linktextValue">
   ...
   <xsl:template mode="LINK_MODE" match="h:a[starts-with(@href, '#')]">
      ...
      <xsl:variable name="newText">
         <xsl:choose>
            <xsl:when test="string-length($target[1]/@temp:linktext) &gt; 0">
   ...
   <xsl:template mode="MOVE_MODE"
                 match="r:dump-bucket[@temp:id='DUMP_BUCKET_iamaglossarypagebucket_d1e64']">
      <xsl:comment> r:dump-bucket[@name='iamaglossarypagebucket'][not(@group-by)] DUMP_BUCKET_iamaglossarypagebucket_d1e64</xsl:comment>
   ...
   <xsl:template mode="MOVE_MODE"
                 match="r:dump-bucket[@temp:id='DUMP_BUCKET_iamapagebucket-key-equations_d1e71']">
      <xsl:comment> r:dump-bucket[@name='iamapagebucket-key-equations'][not(@group-by)] DUMP_BUCKET_iamapagebucket-key-equations_d1e71</xsl:comment>
   ...
   <xsl:template mode="MOVE_MODE"
                 match="r:dump-bucket[@temp:id='DUMP_BUCKET_iamapagebucket-summary_d1e78']">
      <xsl:param tunnel="yes" name="nearestReplacerContext" as="element()"/>
      <xsl:variable name="groups" select="$nearestReplacerContext/*[@data-type='page']"/>
      <xsl:comment> DUMP_BUCKET_iamapagebucket-summary_d1e78 . Found {count($groups)} groups to loop over</xsl:comment>
      <xsl:comment>nearestReplacerContext is a {local-name($nearestReplacerContext)} with data-type={$nearestReplacerContext/@data-type}</xsl:comment>
   ...
   <xsl:template mode="MOVE_MODE"
                 match="r:dump-bucket[@temp:id='DUMP_BUCKET_iamapagebucket-exercises_d1e85']">
      <xsl:param tunnel="yes" name="nearestReplacerContext" as="element()"/>
      <xsl:variable name="groups" select="$nearestReplacerContext/*[@data-type='page']"/>
      <xsl:comment> DUMP_BUCKET_iamapagebucket-exercises_d1e85 . Found {count($groups)} groups to loop over</xsl:comment>
      <xsl:comment>nearestReplacerContext is a {local-name($nearestReplacerContext)} with data-type={$nearestReplacerContext/@data-type}</xsl:comment>
      <xsl:for-each select="$nearestReplacerContext/*[@data-type='page']">
         <xsl:variable name="groupEl" select="."/>
         <xsl:variable name="title" select="./*[@data-type='document-title']"/>
   ...
   <xsl:template mode="NUMBER_MODE"
                 match="r:copy-content[@temp:id='COPY_CONTENT__d1e370']">
      <xsl:param tunnel="yes" name="nearestReplacerContext" as="element()"/>
      <xsl:variable name="nodesToCopy"
                    select="$nearestReplacerContext/*[@data-type='document-title']/node()"/>
      <xsl:if test="empty($nodesToCopy)">
         <xsl:message terminate="yes">ERROR: Could not find anything to copy when selecting "*[@data-type='document-title']/node()". inside r:copy-content for 'COPY_CONTENT__d1e370'. nearestReplacerContext is a @data-type="{$nearestReplacerContext/@data-type}" id="{$nearestReplacerContext/@id}" class="{$nearestReplacerContext/@class}".</xsl:message>
      </xsl:if>
      <xsl:apply-templates mode="NUMBER_MODE"
                           select="$nearestReplacerContext/*[@data-type='document-title']/node()"/>
   </xsl:template>
   <xsl:template mode="NUMBER_MODE"
                 match="r:copy-content[@temp:id='COPY_CONTENT__d1e401']">
      <xsl:param tunnel="yes" name="nearestReplacerContext" as="element()"/>
      <xsl:variable name="nodesToCopy"
                    select="$nearestReplacerContext/*[@data-type='document-title']/node()"/>
      <xsl:if test="empty($nodesToCopy)">
         <xsl:message terminate="yes">ERROR: Could not find anything to copy when selecting "*[@data-type='document-title']/node()". inside r:copy-content for 'COPY_CONTENT__d1e401'. nearestReplacerContext is a @data-type="{$nearestReplacerContext/@data-type}" id="{$nearestReplacerContext/@id}" class="{$nearestReplacerContext/@class}".</xsl:message>
      </xsl:if>
      <xsl:apply-templates mode="NUMBER_MODE"
                           select="$nearestReplacerContext/*[@data-type='document-title']/node()"/>
   </xsl:template>
